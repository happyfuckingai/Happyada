...
import "./components/VideoFeed.css";
...
function App() {
  ...
  // Toggle webcam visibility
    const handleToggleVideoFeed = useCallback(() => {
    console.log("Toggling video feed visibility");
    setShowVideoFeed((prevShow) => {
      const becomingHidden = !prevShow; // Is the video feed turning OFF now?
  ...
  return (
    <div className="app-container">
      ...
      <InputArea
        ...
        micSupported={micSupported}
        isVideoFeedVisible={showVideoFeed}
        onToggleVideoFeed={handleToggleVideoFeed}
      />

      {/* Widgets Area - Render conditionally based on state */}
      <VideoFeed
        isVisible={showVideoFeed}
        onClose={handleToggleVideoFeed}
        socket={socket} // Pass socket ref to VideoFeed
      />
